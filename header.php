		...
		<div class="main_menu">
			<nav class="navbar navbar-expand-lg navbar-light main_box">
				<div class="container">
					...
					<a class="navbar-brand logo_h" href="index.php"><h4>JJ Shopping<h4></a>
						...
						<ul class="nav navbar-nav navbar-right">
							<li class="nav-item">
								<a href="cart.php" class="cart">
									<span class="ti-bag"><sup style="font-weight: 550;font-size: 15px;color: red"><?php echo $cart ?></sup></span>
								</a>
							</li>
							<li class="nav-item">
