<?php
	...
	$stmt = $pdo->prepare("INSERT INTO sale_orders(customer_id,total_price) VALUES (:user_id,:total_price)");
	$result = $stmt->execute(
		array(':user_id'=>$userId, ':total_price'=>$total)
	);
