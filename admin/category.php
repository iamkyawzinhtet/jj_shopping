  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">JJ Shopping | Category</a>
        </div>
      </div>
                  ...
                  <tbody>
                    ...
                    ?>
                        <tr>
                          ...
                          <td>
                            <a href="cat_edit.php?id=<?php echo($value['id'])?>" class="btn btn-primary">Edit</a>
                            <a href="cat_delete.php?id=<?php echo($value['id'])?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this?')">
                              Delete
                            </a>
                          </td>
                        </tr>
